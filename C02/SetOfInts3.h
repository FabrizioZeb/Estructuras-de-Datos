...
private:
    ...
    bool isFull() const;
    void binSearch(T x, bool& found, int& pos) const;
    int binSearchAux(T x, int a, int b) const;
...
template <class T>
int SetOfInts3<T>::binSearchAux(T x, int a, int b) const {
...
template <class T>
void SetOfInts3<T>::binSearch(T x, bool& found, int& pos) const {
